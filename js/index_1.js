...
var myList = '5c6d05a8f4d0e337f036c443';
...
'<div><div id="sendMessage" class="ld-ext-right contactMButton">SEND MESSAGE<div class="ld ld-ring ld-spin"></div></div>'+'</div>';let contactModal=new jBox('Modal',{attach:'.contactStart',width:750,height:430,trigger:'click',onCreated:function(){this.setContent(modalContent)
...
return}else{$("#errEmailMsg").removeClass("displayErr");$("#emailFirst").removeClass("invalidValue")}
